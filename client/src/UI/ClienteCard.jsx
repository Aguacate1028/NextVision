  ...
  return (
    <div className="bg-white p-6 rounded-[2.5rem] shadow-xl shadow-blue-900/5 border border-white hover:scale-[1.02] transition-all group relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-black text-xl shadow-lg shadow-blue-200 uppercase">
          {cliente.nombres?.charAt(0) || 'U'}
        </div>
        <div className="flex-1">
          <h3 className="text-lg font-black text-slate-900 leading-tight">
            {cliente.nombres} {cliente.apellidos}
          </h3>
          <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest block truncate max-w-[180px]">
            {cliente.email}
          </span>
        </div>
      </div>
